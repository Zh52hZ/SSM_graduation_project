					...
					<form method="post">
						<table class="table table-hover">
							...
							<tr>
								...
								<td width="60%"><input type="text" name="pwd" id="pwd" class="form-control" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="60%"><input type="text" name="telphone" id="telphone"
									class="form-control" /></td>
							</tr>
							<tr>
								<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">邮&#8194;&#8194;&#8194;&#8194;箱：</td>
								<td width="60%"><input type="text" name="email" id="email"
									class="form-control" /></td>
							</tr>
...
function save() {
	...
	var r=confirm("您确认添加该用户信息吗？请您确认信息无误后在添加!");
	if (r==true)
 	 {
		document.forms[0].action = "<%=path%>/loginuser/addloginuser";
		document.forms[0].submit();
		/* alert("${messageInfo}"); */
		setTimeout(alert("用户信息添加成功！"), 1000);
  	}
}
</script>