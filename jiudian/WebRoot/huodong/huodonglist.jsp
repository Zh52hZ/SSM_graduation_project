		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				...
				<div class="title_right">
					...
					<strong>活动信息管理</strong>
				</div>
				<div style="width: 1100px; margin: auto">
					<form method="post">
						<table class="table">
						<tr>
							<td width="10%" align="center" nowrap="nowrap" bgcolor="#f1f1f1">活动名称：</td>
						...
						href="<%=path%>/huodong/huodongadd.jsp" role="button"><i
							class="icon-plus icon-white"></i> 添加活动</a>
        						...
        						<input id="Button2" type="button" value="刷新数据"  class="layui-btn layui-btn-primary layui-btn-sm" onclick="javascript: location.reload()" />  
					...
					<caption hidden id="lbl_innum_link">活动信息</caption>
						<thead>
							<tr align="center">
							...
							<c:forEach items="${huodongList}" var="huodong">
								<tr align="center">
									...
									<td class="s_close" nowrap="nowrap"><a
										href="<%=path%>/huodong/toupdatehuodong?id=${huodong.id}"><i class="layui-icon">&#xe642;</i>编辑</a>&nbsp;|&nbsp;<a
										href="<%=path%>/huodong/deletehuodong?id=${huodong.id}"><i class="layui-icon">&#xe640;</i>删除</a></td>
